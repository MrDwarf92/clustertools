...
#Volumes in [nm3] of the unit cells of [Fe, beta, eta]
unit_volumes = np.array([0.0118199515, 0.011943936, 0.04575])
...
v_spec = float(input('Enter the volume per atom of the unit cell: '))
...
#Fv = (ions_precip*unit_volumes[type])/(ions_total*unit_volumes[0])
Fv = ((ions_precip/0.37)*v_spec)/vtotal
